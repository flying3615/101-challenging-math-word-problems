(() => {
  ...
  const text = {
    en: {
      ...
      solutionHelp: 'Need more help?', solutionLead: 'Reveal 1 step at a time, then try the question yourself.', startGuidedSolution: 'Guide me step by step', nextSolutionStep: 'Show next step', showSolutionAnswer: 'Show answer and check', tryIndependently: 'Try it again on my own', solutionStrategy: 'Plan', solutionAnswer: 'Answer and check',
    ...
    'zh-Hans': {
      ...
      solutionHelp: '需要更多帮助吗？', solutionLead: '一次显示 1 步，再自己尝试解题。', startGuidedSolution: '带我一步一步做', nextSolutionStep: '显示下一步', showSolutionAnswer: '显示答案与检查方法', tryIndependently: '再自己试一次', solutionStrategy: '解题计划', solutionAnswer: '答案与检查方法',
