(() => {
  ...
  const text = {
    ...
    'zh-Hans': {
      ...
      solutionHelp: '需要更多帮助吗？', solutionLead: '一次显示 1 步，再自己尝试解题。', startGuidedSolution: '带我一步一步做', nextSolutionStep: '显示下一步', showSolutionAnswer: '显示答案与检查方法', hideGuidedSolution: '隐藏解题步骤', resumeGuidedSolution: '再次显示解题步骤', tryIndependently: '再自己试一次', solutionStrategy: '解题计划', solutionAnswer: '答案与检查方法',
