window.QUESTION_BANK = [
  ...
  },
  {
    ...
    "answer": "188 cm",
    "model": "geometry",
    "hint": "The big square's corners land on the centre of each smaller square, so the outline picks up all 4 sides of the 32 cm square plus 2 sides' worth of each smaller square.",
    "questionZh": "下图由3个相互重叠的正方形组成。正方形的边长分别为12 cm、18 cm和32 cm。求该图形的周长。",
    "hintZh": "大正方形的角正好落在每个小正方形的中心，所以外框走过 32 cm 正方形的 4 条边，再加上每个小正方形 2 条边的长度。"
  },
  {
    "id": 88,
    "topic": "Area and Perimeter",
    ...
    "answer": "146 cm",
    "model": "geometry",
    "hint": "The 2 squares sit above exactly 3 of the rectangles, so share 15 + 15 cm among 3 to get a rectangle's width; its height is 33 − 15 cm.",
    "questionZh": "下图由2个相似的正方形和4个相似的长方形组成。每个正方形的边长为15 cm，图形的总高为33 cm。求该图形的周长。",
    "hintZh": "2 个正方形正好压在其中 3 个长方形的上方，所以把 15 + 15 cm 平均分成 3 份就是长方形的宽，长方形的高是 33 − 15 cm。"
  },
  {
    "id": 89,
    "topic": "Area and Perimeter",
  ...
  {
    "id": 97,
    "topic": "2-part: The Four Operations of Whole Numbers",
