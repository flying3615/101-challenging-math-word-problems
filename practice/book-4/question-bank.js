window.QUESTION_BANK = [
  {
    ...
    "questionZh": "学校营地第1天有396名儿童。第2天有27名男孩离开营地。若留在营地的男孩人数是女孩人数的2倍，营地第1天有多少名男孩？",
    "hintZh": "先求出留在营地的儿童总数。把这个总数按男孩2等份、女孩1等份分配，再加回离开的男孩。",
    "solution": {
      "en": {
        "strategy": "First remove the boys who left, then use the 2:1 ratio of the children who remained.",
        "steps": [
          {
            "title": "Find the number remaining",
            "text": "396 − 27 = 369 children remained at the camp."
          },
          {
            "title": "Split the remaining children by the ratio",
            "text": "Boys : girls = 2 : 1, so 369 ÷ 3 = 123 in 1 unit. The remaining boys filled 2 units, or 2 × 123 = 246."
          },
          {
            "title": "Restore the boys who left",
            "text": "The 27 boys who left were part of the original number of boys, so add them back."
          }
        ],
        "answerCheck": "246 + 27 = 273, so there were 273 boys on the 1st day."
      },
      "zh-Hans": {
        "strategy": "先扣除离开的男孩，再按留下儿童的2:1人数比来分配。",
        "steps": [
          {
            "title": "求留下的儿童人数",
            "text": "396 − 27 = 369，营地里留下369名儿童。"
          },
          {
            "title": "按人数比分配",
            "text": "男孩 : 女孩 = 2 : 1，所以369 ÷ 3 = 123，每1份是123人。留下的男孩有2份，即2 × 123 = 246。"
          },
          {
            "title": "加回离开的男孩",
            "text": "离开的27名男孩本来属于第1天的男孩人数，所以要加回。"
          }
        ],
        "answerCheck": "246 + 27 = 273，所以第1天有273名男孩。"
      }
    }
  },
  {
    ...
    "questionZh": "星期一，汤姆农夫收集的鸡蛋数量是杰克农夫的3倍。星期二，汤姆农夫卖出160个鸡蛋。此时杰克农夫的鸡蛋数量是汤姆农夫的2倍。杰克农夫有多少个鸡蛋？",
    "hintZh": "卖出前，把汤姆表示为3份、杰克表示为1份。卖出后，杰克比汤姆多2份；利用相差的160个鸡蛋。"
  },
  {
    "id": 3,
    "topic": "Whole Numbers",
    ...
    "questionZh": "乔治15岁时，他的妹妹8岁，父亲45岁。当乔治的年龄是父亲年龄的1/2时，乔治的妹妹几岁？",
    "hintZh": "父亲始终比乔治大30岁。先求乔治年龄是父亲年龄1/2时的年龄，再把相同的年数加到妹妹的年龄上。"
  },
  {
    "id": 4,
    "topic": "Whole Numbers",
    ...
    "questionZh": "琳达和瑟琳娜原来有同样多的气球。琳达用掉16个气球后，瑟琳娜的气球数量是琳达的3倍。瑟琳娜原来有多少个气球？",
    "hintZh": "琳达用掉气球后，瑟琳娜未变的数量是3等份，琳达是1等份。相差的2份是16个。"
  },
  {
    "id": 5,
    "topic": "Whole Numbers",
    ...
    "questionZh": "詹妮弗举行派对，想把气球平均分给她的6位朋友。如果其中1位朋友没有来参加派对，其余的人每人可以多得到2个气球。詹妮弗有多少个气球？",
    "hintZh": "少了1位朋友后，5位朋友每人多得2个气球。这部分额外分配共10个气球；用它求出原来每人的份数。"
  },
  {
    "id": 6,
    "topic": "Whole Numbers",
    ...
    "questionZh": "安娜的珠子数量是佐伊的3倍，两人共有480颗珠子。泰勒太太给她们每人同样多的珠子。之后，佐伊的珠子数量是安娜的1/2。泰勒太太一共给了她们多少颗珠子？",
    "hintZh": "开始时，安娜和佐伊分别是3份和1份。加上相同数量不会改变她们的差；收到珠子后，安娜比佐伊多2份。"
  },
  {
    "id": 7,
    "topic": "Whole Numbers",
  ...
  },
  {
    ...
    "questionZh": "扎克和曼迪分120颗糖。扎克给曼迪10颗糖后，扎克的糖数是曼迪的2倍。他们开始时各有多少颗糖？",
    "hintZh": "转移后，扎克和曼迪的数量比是2:1。利用总数120求出转移后的数量，再倒推回转移前的10颗糖。",
    "solution": {
      "en": {
        "strategy": "The total stays 120 after the transfer, so find the 2:1 amounts first and then reverse the 10-sweet transfer.",
        "steps": [
          {
            "title": "Use the after-transfer ratio",
            "text": "After Zack gives sweets away, Zack : Mandy = 2 : 1. The 3 equal units total 120, so 1 unit is 120 ÷ 3 = 40 sweets."
          },
          {
            "title": "Find the after-transfer amounts",
            "text": "Zack then had 2 × 40 = 80 sweets and Mandy had 1 × 40 = 40 sweets."
          },
          {
            "title": "Reverse the transfer",
            "text": "Before the transfer, put the 10 sweets back with Zack and take the same 10 sweets away from Mandy."
          }
        ],
        "answerCheck": "Zack: 80 + 10 = 90 sweets; Mandy: 40 − 10 = 30 sweets. These total 120, and after transferring 10, 80 is 2 times 40."
      },
      "zh-Hans": {
        "strategy": "转移糖果后总数仍是120，先按2:1求转移后的数量，再倒推回去。",
        "steps": [
          {
            "title": "使用转移后的人数比",
            "text": "转移后，扎克 : 曼迪 = 2 : 1。3份共120颗糖，所以1份是120 ÷ 3 = 40颗。"
          },
          {
            "title": "求转移后的数量",
            "text": "扎克有2 × 40 = 80颗糖，曼迪有1 × 40 = 40颗糖。"
          },
          {
            "title": "倒推转移前的数量",
            "text": "转移前，把10颗糖加回扎克，并从曼迪的数量中减去同样的10颗糖。"
          }
        ],
        "answerCheck": "扎克：80 + 10 = 90颗糖；曼迪：40 − 10 = 30颗糖。2人共120颗糖，转移10颗后80正好是40的2倍。"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "questionZh": "南希的钱是本的1/3。露西比本多$20。他们一共有$132。三人各有多少钱？",
    "hintZh": "把南希设为1份、本设为3份。先从总数中减去露西多出的$20，再把剩下的7份平均分配。"
  },
  {
    "id": 11,
    "topic": "Fractions",
    ...
    "solution": {
      "en": {
        "strategy": "Follow the parcel changes in order: subtract from Parcel A to get B, then add to B to get C.",
        "steps": [
          {
            "title": "Find Parcel B",
            "text": "Parcel A is 4 1/2 kg. Using twelfths, 4 1/2 − 3/4 = 4 6/12 − 9/12 = 3 9/12 kg."
          },
          {
            "title": "Add the extra mass for Parcel C",
            "text": "Parcel C is 2/3 kg heavier than B. Change 2/3 to 8/12 and add it to 3 9/12 kg."
          }
        ],
        "answerCheck": "3 9/12 + 8/12 = 4 5/12, so Parcel C has a mass of 4 5/12 kg."
      },
      "zh-Hans": {
        "strategy": "按包裹质量变化的顺序计算：先由A减去3/4 kg求B，再由B加上2/3 kg求C。",
        "steps": [
          {
            "title": "求B包裹的质量",
            "text": "A包裹是4 1/2 kg。化成以12为分母：4 1/2 − 3/4 = 4 6/12 − 9/12 = 3 9/12 kg。"
          },
          {
            "title": "加上C包裹多出的质量",
            "text": "C包裹比B包裹重2/3 kg。把2/3化成8/12，再加到3 9/12 kg。"
          }
        ],
        "answerCheck": "3 9/12 + 8/12 = 4 5/12，所以C包裹的质量是4 5/12 kg。"
      }
    }
  },
  {
    ...
    "questionZh": "赖斯先生把薪水的1/5用于食物，2/3用于衣服。剩余金额的1/2给了妻子，另1/2存起来。若他存了$520，赖斯先生的薪水是多少？",
    "hintZh": "把1/5和2/3化成以15为分母的分数。扣除食物和衣服后，将剩余的部分平均分给妻子和储蓄。"
  },
  {
    "id": 13,
    "topic": "Fractions",
    ...
    "questionZh": "萨姆有一些弹珠。他把其中的1/7给了弟弟。剩余弹珠的2/3给了表亲，其余放在盒子里。若盒子里有48颗弹珠，萨姆给表亲的弹珠比给弟弟的多多少颗？",
    "hintZh": "给出1/7后，剩下的6/7中有2/3给表亲，1/3留下。由留下的48颗弹珠倒推。"
  },
  {
    "id": 14,
    "topic": "Fractions",
    ...
    "questionZh": "安德森太太买了60个鸡蛋。她用其中的2/5烤蛋糕，又用一些鸡蛋烤饼干，剩下12个鸡蛋。她用了多少个鸡蛋烤饼干？",
    "hintZh": "先求60的2/5作为烤蛋糕用的鸡蛋数，再从60中减去烤蛋糕用的和剩下的鸡蛋数。"
  },
  {
    "id": 15,
    "topic": "Fractions",
    ...
    "questionZh": "乡村俱乐部会员中，2/7是男性。50岁以下的女性有1050人。若俱乐部中女性比男性多960人，50岁以上的女性有多少人？",
    "hintZh": "男性占俱乐部的2/7，所以女性占5/7。女性与男性相差3等份，即960人。"
  },
  {
    "id": 16,
    "topic": "Fractions",
    ...
    "questionZh": "斯蒂芬妮共有80张$2和$10纸币。她花掉了$2纸币的2/5和8张$10纸币后，剩下的$2纸币与$10纸币数量相等。斯蒂芬妮开始时有多少钱？",
    "hintZh": "剩下的2种纸币数量相等。已花掉8张$10纸币，利用纸币总张数求出2种纸币原来的张数，再计算总金额。"
  },
  {
    "id": 17,
    "topic": "Fractions",
    ...
    "questionZh": "农场里的动物中，3/5是鸭子，其余是鸡。鸡中1/5是棕色的，其余是白色的。若有24只白鸡，农场里的鸭子比鸡多多少只？",
    "hintZh": "白鸡占所有鸡的4/5。先求鸡的总数，再利用鸭子与鸡的3:2比例。"
  },
  {
    "id": 18,
    "topic": "Fractions",
    ...
    "questionZh": "苏珊每月赚$2450。她花掉其中的2/5，剩余存起来。安迪比苏珊每月少赚$800，每月却比苏珊多花$180，其余存起来。1/2年内苏珊能比安迪多存多少钱？",
    "hintZh": "先求苏珊每月的存款，再考虑安迪收入较少和支出较多，求出安迪每月的存款。把每月差额乘以6。"
  },
  {
    "id": 19,
    "topic": "Fractions",
    ...
    "questionZh": "星期一，一位店主卖出12 1/2 kg面粉。星期二比星期一多卖5/6 kg。星期三比星期二少卖1 1/3 kg。之后店里还剩1/3 kg面粉。他开始时有多少面粉？",
    "hintZh": "由星期一求星期二，再由星期二求星期三。把3天卖出的面粉和剩下的面粉相加，并以6为公分母。",
    "solution": {
      "en": {
        "strategy": "Work through Monday, Tuesday, and Wednesday, then add the flour sold and the flour left over.",
        "steps": [
          {
            "title": "Find Tuesday’s sale",
            "text": "Tuesday was 5/6 kg more than Monday: 12 1/2 + 5/6 = 12 3/6 + 5/6 = 13 2/6 kg."
          },
          {
            "title": "Find Wednesday’s sale",
            "text": "Wednesday was 1 1/3 kg less than Tuesday: 13 2/6 − 1 2/6 = 12 kg."
          },
          {
            "title": "Put every amount in sixths",
            "text": "Monday, Tuesday, Wednesday, and the amount left are 75/6 kg, 80/6 kg, 72/6 kg, and 2/6 kg respectively."
          }
        ],
        "answerCheck": "(75 + 80 + 72 + 2) ÷ 6 = 229/6 = 38 1/6, so the shopkeeper had 38 1/6 kg of flour at 1st."
      },
      "zh-Hans": {
        "strategy": "依次求出第1天、第2天和第3天卖出的面粉，再加上剩余的面粉。",
        "steps": [
          {
            "title": "求第2天卖出的面粉",
            "text": "第2天比第1天多卖5/6 kg：12 1/2 + 5/6 = 12 3/6 + 5/6 = 13 2/6 kg。"
          },
          {
            "title": "求第3天卖出的面粉",
            "text": "第3天比第2天少卖1 1/3 kg：13 2/6 − 1 2/6 = 12 kg。"
          },
          {
            "title": "把所有数量化成以6为分母",
            "text": "第1天、第2天、第3天和剩下的面粉分别是75/6 kg、80/6 kg、72/6 kg和2/6 kg。"
          }
        ],
        "answerCheck": "(75 + 80 + 72 + 2) ÷ 6 = 229/6 = 38 1/6，所以店主开始时有38 1/6 kg面粉。"
      }
    }
  },
  {
    ...
    "questionZh": "一个盒子里的玩具车中，2/7是银色的。剩余玩具车的1/10是黄色的，其余是黑色的。若有28辆银色玩具车，盒子里有多少辆黑色玩具车？",
    "hintZh": "用银色玩具车数量求总数。黄色玩具车是剩余5/7的1/10；从总数减去银色和黄色的数量。"
  },
  {
    "id": 21,
    "topic": "Fractions",
    ...
    "questionZh": "安德鲁和瑞安分一些巧克力。安德鲁送出自己巧克力的1/4，其中的1/4被瑞安拿走。之后瑞安的巧克力数量与安德鲁相同。若安德鲁送出了12颗巧克力，他们开始时各有多少颗？",
    "hintZh": "送出的12颗巧克力是安德鲁原有数量的1/4。瑞安得到这12颗中的1/4；利用最后数量相等倒推。"
  },
  {
    "id": 22,
    "topic": "Fractions",
    ...
    "questionZh": "A盒和B盒共有112支铅笔。将A盒铅笔的1/5转移到B盒后，两盒铅笔数量相等。开始时A盒比B盒多多少支铅笔？",
    "hintZh": "转移A盒的1/5后，两盒数量相等。把A盒画成5份，并结合转移前后总数112进行比较。"
  },
  {
    "id": 23,
    "topic": "Fractions",
    ...
    "questionZh": "安德莉亚把薪水的1/5用于食物，1/10用于交通。她把剩余的钱平均给了3个兄弟。其中1个兄弟把钱全部用来买一台$86的收音机和一只$145的手表。安德莉亚的薪水是多少？",
    "hintZh": "1个兄弟得到的钱是$86 + $145。乘以3得到全部剩余金额，再注意到这相当于安德莉亚薪水的7/10。"
  },
  {
    "id": 24,
    "topic": "Fractions",
    ...
    "questionZh": "安和詹姆斯有一些贴纸。安把自己贴纸的1/4给詹姆斯后，詹姆斯的贴纸数量是安的2倍。若他们共有117张贴纸，开始时各有多少张？",
    "hintZh": "把安原有的贴纸看成4等份。转移1份给詹姆斯后，最后比例为2:1；利用不变的总数117。"
  },
  {
    "id": 25,
    "topic": "Fractions",
    ...
    "questionZh": "布朗太太把自己钱的4/7给了儿子。儿子用其中的2/5买了一双鞋，剩余的钱买了2本书，每本$18。布朗太太开始时有多少钱？",
    "hintZh": "书共花$36，这是儿子买鞋后剩余钱的3/5。先求儿子得到的钱，再由4/7求布朗太太全部的钱。",
    "solution": {
      "en": {
        "strategy": "The cost of the 2 books tells us the fraction of the son’s money left after buying shoes; then scale from his share to all of Mrs Brown’s money.",
        "steps": [
          {
            "title": "Find the money left for books",
            "text": "The 2 books cost 2 × $18 = $36. This is the 3/5 of the son’s money not spent on shoes."
          },
          {
            "title": "Find the son’s share",
            "text": "If 3/5 is $36, then 1/5 is $36 ÷ 3 = $12. His whole share is 5 × $12 = $60."
          },
          {
            "title": "Scale from 4/7 to the whole amount",
            "text": "The $60 is 4/7 of Mrs Brown’s original money, so divide by 4 and multiply by 7."
          }
        ],
        "answerCheck": "$60 ÷ 4 × 7 = $105, so Mrs Brown had $105 at 1st."
      },
      "zh-Hans": {
        "strategy": "2本书的价钱表示儿子买鞋后剩下的钱，先求儿子得到的钱，再由他的4/7求布朗太太全部的钱。",
        "steps": [
          {
            "title": "求买书的钱",
            "text": "2本书的价钱是2 × $18 = $36。这是儿子买鞋后剩下的3/5。"
          },
          {
            "title": "求儿子得到的钱",
            "text": "3/5是$36，所以1/5是$36 ÷ 3 = $12。儿子得到的全部钱是5 × $12 = $60。"
          },
          {
            "title": "从4/7还原成全部钱",
            "text": "$60是布朗太太开始时钱的4/7，所以先除以4，再乘以7。"
          }
        ],
        "answerCheck": "$60 ÷ 4 × 7 = $105，所以布朗太太开始时有$105。"
      }
    }
  },
  {
    ...
    "questionZh": "雷卖出的慈善券数量是辛迪卖出数量的2/3。辛迪卖出的慈善券数量是吉娜卖出数量的3/4。每张慈善券售价$2。孩子们共筹集$648。吉娜卖出了多少张慈善券？",
    "hintZh": "先把$648换算成慈善券总张数。使用统一的份数条：吉娜、辛迪和雷可分别表示为4、3和2份。"
  },
  {
    "id": 27,
    "topic": "Fractions",
    ...
    "questionZh": "A盒糖果数量是B盒的3/4。取走A盒糖果的1/2和B盒糖果的3/8后，两盒共剩152颗糖。开始时每盒各有多少颗糖？",
    "hintZh": "把3/4化为6/8，并以八分之几表示A盒和B盒。然后保留A盒的1/2和B盒的5/8来表示剩下的152颗糖。"
  },
  {
    "id": 28,
    "topic": "Fractions",
    ...
    "questionZh": "购物后，迈克花掉自己钱的3/5，伊冯花掉自己钱的1/2，苏花了$50。之后他们剩下的钱一样多。若剩余钱的总数是$54，迈克和苏开始时的钱一共是多少？",
    "hintZh": "3份相等的剩余钱合计$54。把迈克原有的钱表示为5份；苏原有的钱等于她相等的剩余钱加上花掉的$50。"
  },
  {
    "id": 29,
    "topic": "Fractions",
  ...
  },
  {
    ...
    "questionZh": "琼和艾伦有一些钱。琼的钱的2/3等于艾伦的钱的1/2。若艾伦把所有的钱买了一本$45的书和一个$98的钱包，琼和艾伦一共有多少钱？",
    "hintZh": "先由书和钱包求艾伦的钱。若琼的2/3等于艾伦的1/2，就把两人的金额都用相同的6等份条表示。"
  },
  {
    "id": 31,
    "topic": "Fractions",
    ...
    "questionZh": "A盒和B盒共有150颗弹珠。将A盒弹珠的1/3转移到B盒，并从B盒取出12颗后，B盒弹珠数量是A盒的2倍。开始时B盒有多少颗弹珠？",
    "hintZh": "取出12颗后还剩138颗，最终两盒的数量比为1:2。把A盒的1/3转移倒推回去，求B盒开始时的数量。"
  },
  {
    "id": 32,
    "topic": "Fractions",
    ...
    "questionZh": "促销期间，贝蒂以手表原价的3/5买了一块手表，之后她还剩$220。若她以原价购买，就会差$10。手表原价是多少？",
    "hintZh": "支付原价的3/5与支付全价的差额是$220 + $10。这一差额是原价的2/5。"
  },
  {
    "id": 33,
    "topic": "Fractions",
    ...
    "questionZh": "史密斯先生星期一卖出鸡蛋的1/4，星期二卖出剩余鸡蛋的1/4，其余在星期三卖出。若星期三卖出144个鸡蛋，他开始时有多少个鸡蛋？",
    "hintZh": "星期一后剩下3/4。星期三卖出的是这部分剩余的3/4，即原来鸡蛋数的9/16。"
  },
  {
    "id": 34,
    "topic": "Fractions",
    ...
    "questionZh": "萨姆的钱刚好可以买4本杂志和3本书。他决定买2本杂志和1本书，之后还剩$84。若一本杂志的价格是一本书的1/3，萨姆开始时有多少钱？",
    "hintZh": "把1本杂志表示为1份，1本书表示为3份。未购买的物品是2本杂志和2本书，价值8份，即$84。"
  },
  {
    "id": 35,
    "topic": "Fractions",
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use equal-size bar units for the equal numbers of pears left in the 2 boxes.",
        "steps": [
          {
            "title": "Make the remaining parts equal",
            "text": "Let the equal remaining amount be 4 units. In box A, 2/3 remains, so A started with 6 units and 2 units were taken. In box B, 4/9 remains, so B started with 9 units and 5 units were taken."
          },
          {
            "title": "Find 1 unit",
            "text": "The pears taken out were 2 + 5 = 7 units. Since 7 units equal 84 pears, 1 unit is 84 ÷ 7 = 12 pears."
          },
          {
            "title": "Use the original bars",
            "text": "The original numbers of pears were 6 units in A and 9 units in B."
          }
        ],
        "answerCheck": "6 × 12 + 9 × 12 = 180, so there were 180 pears in both boxes at 1st."
      },
      "zh-Hans": {
        "strategy": "把2盒中相等的剩余梨数看作相同大小的单位条。",
        "steps": [
          {
            "title": "让剩余部分相等",
            "text": "把相等的剩余梨数设为4份。A盒剩下2/3，所以A盒原有6份，取出2份。B盒剩下4/9，所以B盒原有9份，取出5份。"
          },
          {
            "title": "求每1份的数量",
            "text": "取出的梨共有2 + 5 = 7份。7份是84个梨，所以1份是84 ÷ 7 = 12个梨。"
          },
          {
            "title": "使用原来的单位条",
            "text": "A盒原有6份梨，B盒原有9份梨。"
          }
        ],
        "answerCheck": "6 × 12 + 9 × 12 = 180，所以开始时2盒共有180个梨。"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Benjamin’s $45 left is the unused 5/7 of his money. Use the matching costs of 3 pens and 5 pencils to find each unit price.",
        "steps": [
          {
            "title": "Find the cost of 3 pens",
            "text": "Benjamin had 5/7 of his money left, and that was $45. So 1/7 was $45 ÷ 5 = $9, and 2/7 spent on 3 pens was 2 × $9 = $18."
          },
          {
            "title": "Find the pencil price",
            "text": "5 pencils cost the same $18, so 1 pencil costs $18 ÷ 5 = $3.60."
          },
          {
            "title": "Find the pen price",
            "text": "3 pens cost $18, so 1 pen costs $18 ÷ 3 = $6."
          }
        ],
        "answerCheck": "$3.60 + $6 = $9.60, so a pencil and a pen cost $9.60 altogether."
      },
      "zh-Hans": {
        "strategy": "本杰明剩下的$45是他钱的5/7。利用3支钢笔和5支铅笔价钱相等，分别求单价。",
        "steps": [
          {
            "title": "求3支钢笔的价钱",
            "text": "本杰明剩下钱的5/7是$45，所以1/7是$45 ÷ 5 = $9。买3支钢笔花的钱是2/7，即2 × $9 = $18。"
          },
          {
            "title": "求铅笔单价",
            "text": "5支铅笔也值$18，所以1支铅笔是$18 ÷ 5 = $3.60。"
          },
          {
            "title": "求钢笔单价",
            "text": "3支钢笔值$18，所以1支钢笔是$18 ÷ 3 = $6。"
          }
        ],
        "answerCheck": "$3.60 + $6 = $9.60，所以1支铅笔和1支钢笔的总价是$9.60。"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "The decrease from a full box to a half-full box is exactly the mass of half the items.",
        "steps": [
          {
            "title": "Find the mass of half the items",
            "text": "45 kg − 33 kg = 12 kg, so 1/2 of the items has a mass of 12 kg."
          },
          {
            "title": "Find the mass of all the items",
            "text": "All the items have a mass of 2 × 12 kg = 24 kg."
          },
          {
            "title": "Find 1 empty box",
            "text": "A full box is 45 kg, so subtract the 24 kg of items to get the mass of 1 empty box."
          }
        ],
        "answerCheck": "45 kg − 24 kg = 21 kg for 1 empty box, and 6 × 21 kg = 126 kg. The mass of 6 empty boxes is 126 kg."
      },
      "zh-Hans": {
        "strategy": "从装满到取出1/2物品的质量减少量，正好是1/2物品的质量。",
        "steps": [
          {
            "title": "求1/2物品的质量",
            "text": "45 kg − 33 kg = 12 kg，所以1/2物品的质量是12 kg。"
          },
          {
            "title": "求全部物品的质量",
            "text": "全部物品的质量是2 × 12 kg = 24 kg。"
          },
          {
            "title": "求1个空盒子的质量",
            "text": "装满的盒子是45 kg，减去24 kg的物品质量，就得到1个空盒子的质量。"
          }
        ],
        "answerCheck": "45 kg − 24 kg = 21 kg，1个空盒子是21 kg；6 × 21 kg = 126 kg，所以6个空盒子的质量是126 kg。"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use the square’s area to find its perimeter. That perimeter came from 2/3 of the original wire.",
        "steps": [
          {
            "title": "Find the side of the square",
            "text": "A square with area 36 cm² has side length 6 cm because 6 × 6 = 36."
          },
          {
            "title": "Find the wire used for the square",
            "text": "The square’s perimeter is 4 × 6 cm = 24 cm. This 24 cm is 2/3 of the original wire."
          },
          {
            "title": "Scale from 2/3 to the whole wire",
            "text": "To change 24 cm from 2/3 to the whole length, multiply by 3 and divide by 2."
          }
        ],
        "answerCheck": "24 cm × 3 ÷ 2 = 36 cm, so the wire was 36 cm long at 1st."
      },
      "zh-Hans": {
        "strategy": "先用正方形面积求周长。这个周长就是原来铁丝的2/3。",
        "steps": [
          {
            "title": "求正方形的边长",
            "text": "正方形面积是36 cm²，边长是6 cm，因为6 × 6 = 36。"
          },
          {
            "title": "求围成正方形的铁丝长度",
            "text": "正方形的周长是4 × 6 cm = 24 cm。这24 cm是原来铁丝的2/3。"
          },
          {
            "title": "从2/3还原成整根铁丝",
            "text": "把24 cm从2/3还原成全部长度，要先乘以3，再除以2。"
          }
        ],
        "answerCheck": "24 cm × 3 ÷ 2 = 36 cm，所以这根铁丝开始时长36 cm。"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Represent 1/5 of the 1st number with 1 variable, then express both whole numbers using that same variable.",
        "steps": [
          {
            "title": "Set up the matching parts",
            "text": "Let 1/5 of the 1st number be x. It is 12 more than 1/2 of the 2nd number, so 1/2 of the 2nd number is x − 12."
          },
          {
            "title": "Write the 2 whole numbers",
            "text": "The 1st number is 5x. The 2nd number is 2(x − 12). Their sum gives 5x + 2(x − 12) = 221."
          },
          {
            "title": "Solve for the shared part",
            "text": "5x + 2x − 24 = 221, so 7x = 245 and x = 35."
          }
        ],
        "answerCheck": "1st number: 5 × 35 = 175. 2nd number: 2 × (35 − 12) = 46. Also, 1/5 of 175 is 35 and 1/2 of 46 is 23, which differ by 12; 175 + 46 = 221."
      },
      "zh-Hans": {
        "strategy": "把第1个数的1/5设为x，再用x表示2个完整的数。",
        "steps": [
          {
            "title": "建立相等部分的关系",
            "text": "设第1个数的1/5是x。它比第2个数的1/2多12，所以第2个数的1/2是x − 12。"
          },
          {
            "title": "写出2个完整的数",
            "text": "第1个数是5x。第2个数是2(x − 12)。它们的和给出5x + 2(x − 12) = 221。"
          },
          {
            "title": "求共同的部分",
            "text": "5x + 2x − 24 = 221，所以7x = 245，x = 35。"
          }
        ],
        "answerCheck": "第1个数：5 × 35 = 175。第2个数：2 × (35 − 12) = 46。而且175的1/5是35，46的1/2是23，相差12；175 + 46 = 221。"
      }
    }
  },
  {
