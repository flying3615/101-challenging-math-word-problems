window.QUESTION_BANK = [
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Translate the stated 40% red / 60% blue split and test the stated halving condition.",
        "steps": [
          {
            "title": "Find the original blue count",
            "text": "If losing 50 blue beads leaves 1/2 of the original blue count, then 50 is the other 1/2. Original blue beads = 100."
          },
          {
            "title": "Apply the colour percentage",
            "text": "Blue is 60% of the original total because red is 40%. So the original total would be 100 ÷ 0.6 = 500/3, and after losing 50 it would be 350/3 beads."
          }
        ],
        "answerCheck": "200 beads. Note: the current source wording gives 350/3 beads, not this answer; the printed-book relationship is that blue was reduced by 1/3 of its original count, which gives 250 − 50 = 200 beads."
      },
      "zh-Hans": {
        "strategy": "把红珠占 40%、蓝珠占 60% 的关系与题目所写的“剩下原来 1/2”一起检验。",
        "steps": [
          {
            "title": "求原来蓝珠数",
            "text": "若失去 50 颗蓝珠后剩下原来蓝珠的 1/2，那么失去的 50 颗也是原来的 1/2，所以原来有 100 颗蓝珠。"
          },
          {
            "title": "代入颜色百分比",
            "text": "红珠占 40%，所以蓝珠占原来总数的 60%。原来总数应为 100 ÷ 0.6 = 500/3 颗，失去 50 颗后为 350/3 颗。"
          }
        ],
        "answerCheck": "当前答案键为 200 颗。按当前题干的 1/2 条件会得到 350/3 颗；印刷书中的条件是减少原来蓝珠的 1/3，才有 250 − 50 = 200 颗。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "First find the three non-blue counts, then use the stated fraction for blue buttons.",
        "steps": [
          {
            "title": "Find yellow and green",
            "text": "Yellow = 820 + 160 = 980 buttons. Green = 820 − 210 = 610 buttons. Orange, yellow, and green total 820 + 980 + 610 = 2410."
          },
          {
            "title": "Use the current fraction",
            "text": "If blue is 1/4 of the total, the 2410 non-blue buttons are 3/4 of the total. Total = 2410 ÷ 3/4 = 9640/3 buttons."
          }
        ],
        "answerCheck": "3615 buttons. Note: the current source says blue is 1/4 of the total, which gives 9640/3; 3615 follows the printed-book 1/3 relationship because 2410 is then 2/3 of 3615."
      },
      "zh-Hans": {
        "strategy": "先求蓝色以外的 3 种按钮数，再使用题干给出的蓝色所占分数。",
        "steps": [
          {
            "title": "求黄、绿按钮数",
            "text": "黄按钮 = 820 + 160 = 980 个；绿按钮 = 820 − 210 = 610 个。橙、黄、绿共 820 + 980 + 610 = 2410 个。"
          },
          {
            "title": "使用当前题干的分数",
            "text": "若蓝按钮占总数的 1/4，则 2410 个非蓝按钮占总数的 3/4。总数 = 2410 ÷ 3/4 = 9640/3 个。"
          }
        ],
        "answerCheck": "当前答案键为 3615 个。当前题干的 1/4 会得到 9640/3；印刷书使用 1/3 时，2410 是总数 3615 的 2/3。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "The final equal count is 160 ÷ 4 = 40; then reverse each transfer using the fraction stated in the current source.",
        "steps": [
          {
            "title": "Set the final amount",
            "text": "Each box finally has 160 ÷ 4 = 40 paperclips. Box A was A − 12 = 40, so A = 52; box D was D − 17 = 40, so D = 57."
          },
          {
            "title": "Reverse box B and C",
            "text": "The current source transfers 1/4 of B after 12 arrive. Thus 3/4(B + 12) = 40, so B = 124/3. Box C then satisfies C + (B + 12)/4 + 17 = 40, so C = 29/3."
          }
        ],
        "answerCheck": "A: 52; B: 48; C: 3; D: 57. Note: those integer values require transferring 1/3 of B, not the current source's 1/4."
      },
      "zh-Hans": {
        "strategy": "最后 4 个盒子相等，每盒有 160 ÷ 4 = 40 个回形针；再按当前题干的分数倒推。",
        "steps": [
          {
            "title": "确定最后每盒数量",
            "text": "每盒最后有 160 ÷ 4 = 40 个。A − 12 = 40，所以 A = 52；D − 17 = 40，所以 D = 57。"
          },
          {
            "title": "倒推 B 和 C",
            "text": "当前题干是转走 B 的 1/4，因此 3/4(B + 12) = 40，B = 124/3。再由 C + (B + 12)/4 + 17 = 40，得到 C = 29/3。"
          }
        ],
        "answerCheck": "当前答案键为 A: 52；B: 48；C: 3；D: 57。该整数答案需要转走 B 的 1/3，而不是当前题干的 1/4。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use the current source's 4/9 red fraction to determine all three colour counts before packing.",
        "steps": [
          {
            "title": "Set equal fractional units",
            "text": "Let the total be 9u. Red = 4u, green = 4u + 35, and yellow = 15. Therefore 4u + (4u + 35) + 15 = 9u, so u = 50."
          },
          {
            "title": "Pack the cars",
            "text": "Red = 200 cars and green = 235 cars, giving 40 + 47 = 87 boxes. Yellow gives 15 ÷ 5 = 3 boxes, so the difference is 87 − 3 = 84 boxes."
          }
        ],
        "answerCheck": "44 boxes. Note: the current source values calculate to 84 boxes, so they do not support the stated answer."
      },
      "zh-Hans": {
        "strategy": "用当前题干“红车占 4/9”的条件先求 3 种颜色的数量，再装箱。",
        "steps": [
          {
            "title": "设总数为 9 份",
            "text": "设总数为 9u。红车有 4u 辆，绿车有 4u + 35 辆，黄车有 15 辆。因此 4u + (4u + 35) + 15 = 9u，所以 u = 50。"
          },
          {
            "title": "按 5 辆装箱",
            "text": "红车有 200 辆，绿车有 235 辆，共有 40 + 47 = 87 箱。黄车有 15 ÷ 5 = 3 箱，差为 87 − 3 = 84 箱。"
          }
        ],
        "answerCheck": "当前答案键为 44 箱。按当前题干的数据计算得到 84 箱，不能得到该答案。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use the current 1/3 starting ratio and then impose the final 2:9 ratio.",
        "steps": [
          {
            "title": "Represent the starting cards",
            "text": "Let David start with x cards. Kristy then starts with 3x cards. After the changes they have x − 9 and 3x + 18."
          },
          {
            "title": "Use the final ratio",
            "text": "(x − 9)/(3x + 18) = 2/9. Cross-multiplying gives 9x − 81 = 6x + 36, so x = 39."
          },
          {
            "title": "Find the final total",
            "text": "David has 39 − 9 = 30 cards and Kristy has 3×39 + 18 = 135 cards. Together they have 165 cards."
          }
        ],
        "answerCheck": "99 cards. Note: the current source relationships calculate to 165 cards, not 99 cards."
      },
      "zh-Hans": {
        "strategy": "采用当前题干“David 是 Kristy 的 1/3”的起始关系，再使用最后的 2:9 比。",
        "steps": [
          {
            "title": "表示起始卡片数",
            "text": "设 David 原来有 x 张卡，Kristy 原来有 3x 张。变化后两人分别有 x − 9 张和 3x + 18 张。"
          },
          {
            "title": "使用最后的比",
            "text": "(x − 9)/(3x + 18) = 2/9。交叉相乘得 9x − 81 = 6x + 36，所以 x = 39。"
          },
          {
            "title": "求最后总数",
            "text": "David 有 39 − 9 = 30 张，Kristy 有 3×39 + 18 = 135 张，共有 165 张。"
          }
        ],
        "answerCheck": "当前答案键为 99 张。按当前题干的关系计算得到 165 张，不是 99 张。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Calculate passers first, then split the failures using the 4-student difference in the current source.",
        "steps": [
          {
            "title": "Count the students who passed",
            "text": "3/4 of 42 students passed, so 42 × 3/4 = 31.5. Of these, 1/4 are girls, or 31.5 × 1/4 = 7.875 girls."
          },
          {
            "title": "Check the remaining students",
            "text": "There would be 42 − 31.5 = 10.5 failures. If failed boys are 4 more than failed girls, failed girls = (10.5 − 4)/2 = 3.25, giving 7.875 + 3.25 = 11.125 girls."
          }
        ],
        "answerCheck": "23 girls. Note: the current source fractions create non-integer student counts; the printed-book 2/3 passed and 9/14 girls among passers give 18 passing girls, 5 failing girls, and 23 girls."
      },
      "zh-Hans": {
        "strategy": "先按当前题干计算及格人数，再用不及格男生比女生多 4 人的关系检验。",
        "steps": [
          {
            "title": "计算及格人数",
            "text": "42 人的 3/4 及格，所以及格人数为 42×3/4 = 31.5 人。其中 1/4 是女生，即 31.5×1/4 = 7.875 人。"
          },
          {
            "title": "检查不及格人数",
            "text": "不及格人数为 42 − 31.5 = 10.5 人。若不及格男生比女生多 4 人，不及格女生为 (10.5 − 4)/2 = 3.25 人，总女生为 7.875 + 3.25 = 11.125 人。"
          }
        ],
        "answerCheck": "当前答案键为 23 名女生。当前题干的分数会产生非整数人数；印刷书的 2/3 及格和及格者中 9/14 是女生，得到 18 名及格女生、5 名不及格女生，共 23 名。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Compute the fractional difference stated in the current source, then multiply the number by 4.",
        "steps": [
          {
            "title": "Find the number",
            "text": "The difference is 2/3 − 1/4 = 5/12 of the number. Thus 5/12 of n = 12, so n = 144/5."
          },
          {
            "title": "Find the requested difference",
            "text": "The fourth multiple is 4n, so its difference from n is 4n − n = 3n = 3×144/5 = 432/5 = 86.4."
          }
        ],
        "answerCheck": "360. Note: the current source fractions give 86.4; 360 follows the printed-book fractions 3/5 and 1/2, for which 1/10 of n = 12 and n = 120."
      },
      "zh-Hans": {
        "strategy": "先按当前题干求两个分数的差，再求该数与它的 4 倍数之差。",
        "steps": [
          {
            "title": "求这个数",
            "text": "当前题干的差为 2/3 − 1/4 = 5/12。因此 5/12×n = 12，n = 144/5。"
          },
          {
            "title": "求所求的差",
            "text": "4 倍数与原数的差为 4n − n = 3n = 3×144/5 = 432/5 = 86.4。"
          }
        ],
        "answerCheck": "当前答案键为 360。当前题干的分数得到 86.4；印刷书使用 3/5 和 1/2 时，1/10×n = 12，n = 120，差为 360。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Since 105 students are eventually equal among 3 groups, each final group has 35 students; reverse the stated moves.",
        "steps": [
          {
            "title": "Work back from groups 1 and 3",
            "text": "Current source: group 1 ends with 3/4 of its original count minus 15, so 3G1/4 − 15 = 35 and G1 = 200/3. Group 3 ends with 80% of its original count plus 15, so 4G3/5 + 15 = 35 and G3 = 25."
          },
          {
            "title": "Find group 2",
            "text": "The original total is 105, so G2 = 105 − 200/3 − 25 = 40/3."
          }
        ],
        "answerCheck": "Group 1: 75; Group 2: 5; Group 3: 25. Note: these source answers require 1/3, rather than the current source's 1/4, to move from group 1: 2/3×75 − 15 = 35."
      },
      "zh-Hans": {
        "strategy": "105 人最后平均分成 3 组，所以每组最后有 35 人；再按当前题干倒推。",
        "steps": [
          {
            "title": "倒推第 1 组和第 3 组",
            "text": "当前题干下，第 1 组最后是原来的 3/4 再减 15，所以 3G1/4 − 15 = 35，G1 = 200/3。第 3 组最后是原来的 80% 再加 15，所以 4G3/5 + 15 = 35，G3 = 25。"
          },
          {
            "title": "求第 2 组",
            "text": "原来总数为 105，所以 G2 = 105 − 200/3 − 25 = 40/3。"
          }
        ],
        "answerCheck": "当前答案键为第 1 组 75 人；第 2 组 5 人；第 3 组 25 人。这个答案需要第 1 组转走 1/3：2/3×75 − 15 = 35，而不是当前题干的 1/4。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use the final 3/4-to-1/2 equality and the 36-car difference before reversing the equal gifts.",
        "steps": [
          {
            "title": "Find the final counts",
            "text": "Let Zack's final count be z and Thomas's be t. From 3z/4 = t/2, t = 3z/2. Since Thomas has 36 more, 3z/2 − z = 36, so z = 72 and t = 108."
          },
          {
            "title": "Reverse the gifts",
            "text": "Zack's final 72 is twice his original count, so he originally had 36 and received 36 cars. Thomas received the same 36 cars, so he originally had 108 − 36 = 72 cars. The gifts total 36 + 36 = 72 cars."
          }
        ],
        "answerCheck": "(a) 108 cars; (b) 90 cars. Note: the current source conditions calculate to (a) 72 cars and (b) 72 cars, not the stated answer."
      },
      "zh-Hans": {
        "strategy": "先利用最后的 3/4 与 1/2 相等关系以及相差 36 辆，求最后数量，再倒推相同的赠送数量。",
        "steps": [
          {
            "title": "求最后的数量",
            "text": "设 Zack 最后有 z 辆，Thomas 最后有 t 辆。3z/4 = t/2，所以 t = 3z/2。Thomas 多 36 辆，即 3z/2 − z = 36，因此 z = 72，t = 108。"
          },
          {
            "title": "倒推赠送的车数",
            "text": "Zack 最后的 72 辆是原来的 2 倍，所以他原来有 36 辆，收到 36 辆。Thomas 也收到 36 辆，所以他原来有 108 − 36 = 72 辆；共送出 36 + 36 = 72 辆。"
          }
        ],
        "answerCheck": "当前答案键为 (a) 108 辆；(b) 90 辆。当前题干条件计算得到 (a) 72 辆；(b) 72 辆，不能得到该答案。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Record the numerical relations that are present, then identify the missing flavour equalities and prices needed to determine the requested values.",
        "steps": [
          {
            "title": "State the available relations",
            "text": "Let cookies be C and cakes be K. The source gives C = K + 140, chocolate cookies = C/2, and chocolate cakes = K/3."
          },
          {
            "title": "Check what is needed",
            "text": "The source refers to “stated equal flavour relationships” but does not state them. It also omits the cookie, cake, and muffin prices. Therefore the missing relationships cannot determine the flavour difference or the total sales."
          }
        ],
        "answerCheck": "(a) 60 more; (b) $350. Note: this exact source answer cannot be derived from the current source wording because required flavour relationships and prices are omitted."
      },
      "zh-Hans": {
        "strategy": "先列出题干中已有的数量关系，再检查求解所需但缺失的口味相等关系和单价。",
        "steps": [
          {
            "title": "列出已有关系",
            "text": "设饼干数为 C，蛋糕数为 K。题干给出 C = K + 140，巧克力饼干为 C/2，巧克力蛋糕为 K/3。"
          },
          {
            "title": "检查缺失信息",
            "text": "题干提到“已说明的口味相等关系”，却没有写出这些关系；也没有给出饼干、蛋糕和松饼的单价。因此不能由当前题干求出口味数量差或总销售额。"
          }
        ],
        "answerCheck": "当前答案键为 (a) 多 60 个；(b) $350。当前题干缺少所需的口味相等关系和单价，无法推出此答案。"
      }
    },
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Audit the stated speed, starting times, meeting fraction, and arrival time before accepting the canonical answer.",
        "steps": [
          {
            "title": "Check the stated arrival time",
            "text": "Jane leaves at 11:00 and drives at 120 km/h until 4:00, a 5 h journey. That gives a total distance of 120 × 5 = 600 km, not 360 km."
          },
          {
            "title": "Check the claimed 2/5 meeting point",
            "text": "For a 600 km journey, 2/5 is 240 km. Jane reaches 240 km at 1:00, but Mark, who started at 10:00 at 75 km/h, is then only 75 × 3 = 225 km from the start. Thus Jane has not passed Mark at that point."
          },
          {
            "title": "Retain the canonical answer",
            "text": "The source facts are internally inconsistent, so the result cannot be derived as written. Keep the source’s canonical answer rather than claiming the arithmetic supports it."
          }
        ],
        "answerCheck": "(a) 360 km; (b) 144 km/h"
      },
      "zh-Hans": {
        "strategy": "先核对75 km/h、10:00、1 h、120 km/h、2/5和4:00这些条件是否能同时成立，再保留规范答案。",
        "steps": [
          {
            "title": "核对到达时间",
            "text": "Jane在11:00出发，以120 km/h行驶到4:00，共5 h。因此全程应为120 × 5 = 600 km，不是360 km。"
          },
          {
            "title": "核对2/5的相遇点",
            "text": "若全程为600 km，2/5是240 km。Jane在1:00到达240 km；但Mark从10:00以75 km/h行驶，到此时只走了75 × 3 = 225 km。因此Jane还没有在该点超过Mark。"
          },
          {
            "title": "保留规范答案",
            "text": "题目中的数值条件彼此矛盾，无法按原文推出结果。因此不声称算式成立，仍保留来源的规范答案。"
          }
        ],
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use the 24 km remainder to find the total distance and verify both requested values against the stated 80 km/h and 12 min.",
        "steps": [
          {
            "title": "Find the total distance",
            "text": "The final 24 km is the remaining 2/5 of the journey, since the first part is 3/5. Thus the whole journey is 24 ÷ (2/5) = 60 km and the first part is 3/5 × 60 = 36 km."
          },
          {
            "title": "Calculate the actual times",
            "text": "At 80 km/h, 36 km takes 36 ÷ 80 h = 0.45 h = 27 min. The second part takes 12 min, so the stated data give 27 + 12 = 39 minutes, while its speed is 24 km ÷ (12/60 h) = 120 km/h."
          },
          {
            "title": "Retain the canonical answer",
            "text": "The stated data support 120 km/h but not 34.5 minutes. The source answer is inconsistent, so retain it without claiming its part (a) calculation works."
          }
        ],
        "answerCheck": "(a) 34.5 minutes; (b) 120 km/h"
      },
      "zh-Hans": {
        "strategy": "用剩下的24 km求全程，再核对80 km/h和12 min能否得到两个规范答案。",
        "steps": [
          {
            "title": "求全程",
            "text": "第一段是3/5，所以剩下的24 km是全程的2/5。全程为24 ÷ (2/5) = 60 km，第一段为3/5 × 60 = 36 km。"
          },
          {
            "title": "计算题目数据实际给出的时间",
            "text": "以80 km/h行驶36 km，需要36 ÷ 80 h = 0.45 h = 27 min。第二段用12 min，因此总时间为27 + 12 = 39 minutes。第二段速度为24 km ÷ (12/60 h) = 120 km/h。"
          },
          {
            "title": "保留规范答案",
            "text": "题目数据支持120 km/h，却不支持34.5 minutes。来源答案不一致，因此保留规范答案，但不声称(a)的算式成立。"
          }
        ],
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Test the 5:45 start, 2 h delay, 100 km/h speed, 3/5 meeting point, and 4 h statement against the three canonical results.",
        "steps": [
          {
            "title": "Check the 400 km result",
            "text": "If the journey were 400 km, Jane would take 400 ÷ 100 = 4 h from her 7:45 departure and arrive at 11:45. At 3/5 of that journey she would be at 240 km after 2.4 h, namely 10:09."
          },
          {
            "title": "Check Tom’s implied speed",
            "text": "Tom starts at 5:45, so reaching 240 km by 10:09 would take 4 h 24 min = 4.4 h. His implied speed is 240 ÷ 4.4 = 54 6/11 km/h, not 75 km/h."
          },
          {
            "title": "Retain the canonical answer",
            "text": "The condensed source does not give a consistent route to all three results; the wording around “4 h later” is also incomplete. Retain the canonical answer without presenting impossible arithmetic as valid."
          }
        ],
        "answerCheck": "(a) 400 km; (b) 75 km/h; (c) 7:05 pm"
      },
      "zh-Hans": {
        "strategy": "核对5:45、2 h、100 km/h、3/5和4 h这些数据，看看是否能同时得到3个规范答案。",
        "steps": [
          {
            "title": "核对400 km",
            "text": "若全程为400 km，Jane从7:45以100 km/h行驶，需要400 ÷ 100 = 4 h，在11:45到达。她到全程3/5，即240 km时，已行驶2.4 h，到达时间为10:09。"
          },
          {
            "title": "核对Tom的隐含速度",
            "text": "Tom从5:45出发，要在10:09到达240 km处，需4 h 24 min = 4.4 h。他的速度应为240 ÷ 4.4 = 54 6/11 km/h，不是75 km/h。"
          },
          {
            "title": "保留规范答案",
            "text": "精简后的来源无法用一致的条件推出全部3个结果，且“4 h later”的指代不完整。因此保留规范答案，不把不可能的算术说成成立。"
          }
        ],
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Translate the 2:1 blue:red ratio and both sales fractions into an equation, then check whether 2400 remaining is possible.",
        "steps": [
          {
            "title": "Set up the initial quantities",
            "text": "Let red towels be x. Then blue towels are 2x and white towels are 4000 − 3x."
          },
          {
            "title": "Form the remaining-total equation",
            "text": "After selling 1/4 of blue towels, 3/4 of 2x = 3x/2 remain. After selling 1/3 of white towels, 2/3(4000 − 3x) remain. Including all x red towels gives x + 3x/2 + 2/3(4000 − 3x) = 2400."
          },
          {
            "title": "Identify the inconsistency",
            "text": "Simplifying gives x/2 + 800/3 = 0, so x = −1600/3. A towel count cannot be negative. The stated facts therefore cannot produce the canonical result; retain it without claiming a valid calculation."
          }
        ],
        "answerCheck": "3200 red and white towels"
      },
      "zh-Hans": {
        "strategy": "把蓝色:红色的2:1和两次卖出的分数写成方程，再检验剩下2400条毛巾是否可能。",
        "steps": [
          {
            "title": "设原来的数量",
            "text": "设红色毛巾为x条，则蓝色毛巾为2x条，白色毛巾为4000 − 3x条。"
          },
          {
            "title": "列出剩余总数方程",
            "text": "卖出蓝色毛巾的1/4后，剩下3/4 × 2x = 3x/2。卖出白色毛巾的1/3后，剩下2/3(4000 − 3x)。再加上全部x条红色毛巾，得到x + 3x/2 + 2/3(4000 − 3x) = 2400。"
          },
          {
            "title": "找出矛盾",
            "text": "化简得x/2 + 800/3 = 0，所以x = −1600/3。毛巾数量不可能为负数，因此题目条件不能推出规范结果；保留规范答案，但不声称计算成立。"
          }
        ],
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Use the 2:3 men-to-women ratio and compare the people remaining with the people leaving.",
        "steps": [
          {
            "title": "Represent the attendance",
            "text": "Let the initial men and women be 2x and 3x. The total attendance is 5x."
          },
          {
            "title": "Compare remaining people and leavers",
            "text": "Men leaving: 1/4 × 2x = x/2. Women leaving: 1/3 × 3x = x. Thus 3x/2 leave and 5x − 3x/2 = 7x/2 remain. Their difference is 7x/2 − 3x/2 = 2x = 24, so x = 12."
          },
          {
            "title": "Identify the source conflict",
            "text": "The stated conditions give 5 × 12 = 60 people, not 120 people. Retain the canonical answer but explicitly note that it is inconsistent with the written data."
          }
        ],
        "answerCheck": "120 people"
      },
      "zh-Hans": {
        "strategy": "利用男人:女人 = 2:3，并比较留下的人数与离开的人数。",
        "steps": [
          {
            "title": "表示原来人数",
            "text": "设原来男人和女人分别为2x和3x，总人数为5x。"
          },
          {
            "title": "比较留下和离开的人数",
            "text": "离开的男人为1/4 × 2x = x/2；离开的女人为1/3 × 3x = x。因此离开3x/2人，留下5x − 3x/2 = 7x/2人。两者相差7x/2 − 3x/2 = 2x = 24，所以x = 12。"
          },
          {
            "title": "指出来源矛盾",
            "text": "题目条件实际给出5 × 12 = 60 people，不是120 people。保留规范答案，但明确说明它与原文数据不一致。"
          }
        ],
  ...
  },
  {
    ...
    "solution": {
      "en": {
        "strategy": "Combine the two ratios and test the condition that C is one quarter of A after 36 sweets are removed.",
        "steps": [
          {
            "title": "Write the combined ratio",
            "text": "Match B in A:B = 7:4 and B:C = 3:2. Taking B as 12 parts gives A:B:C = 21:12:8. Let the counts be 21x, 12x, and 8x."
          },
          {
            "title": "Apply the final condition",
            "text": "After removing 36 from A, the condition C = 1/4 of A gives 8x = (21x − 36)/4. Multiplying by 4 gives 32x = 21x − 36, so 11x = −36."
          },
          {
            "title": "Identify the inconsistency",
            "text": "This requires x = −36/11, which is impossible for a sweet count. The source facts cannot yield the canonical answer, so retain it without claiming the arithmetic works."
          }
        ],
        "answerCheck": "128 sweets"
      },
      "zh-Hans": {
        "strategy": "先合并两个比，再检验从A拿走36颗糖后C是A的1/4这一条件。",
        "steps": [
          {
            "title": "写出合并后的比",
            "text": "令A:B = 7:4和B:C = 3:2中的B都为12份，得到A:B:C = 21:12:8。设三者分别为21x、12x和8x。"
          },
          {
            "title": "代入最后条件",
            "text": "从A拿走36颗糖后，C = A的1/4给出8x = (21x − 36)/4。两边乘4，得32x = 21x − 36，所以11x = −36。"
          },
          {
            "title": "指出矛盾",
            "text": "这要求x = −36/11，糖果数量不可能为负。因此来源条件不能得到规范答案；保留规范答案，但不声称算术成立。"
          }
        ],
